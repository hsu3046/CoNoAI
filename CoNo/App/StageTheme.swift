...
enum StageTheme {
    ...
    static let faintInk = Color(red: 0.36, green: 0.38, blue: 0.54)
    /// 불러야 할 음·색칠된 가사
            ...
            ZStack {
                ...
                if let artwork {
                    Image(nsImage: artwork)
                        ...
                        .clipped()
                        .transition(.opacity)
                    // 가사가 잘 읽히게 아래쪽을 다시 어둡게
                    LinearGradient(colors: [.clear, StageTheme.night.opacity(0.75)], startPoint: .top, endPoint: .bottom)
                }
                RadialGradient(
